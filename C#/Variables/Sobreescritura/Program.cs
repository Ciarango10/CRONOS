namespace Sobreescritura
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SaleWithTax saleWithTax = new SaleWithTax(10, 1.19m);
            saleWithTax.Add(2);
            saleWithTax.Add(3);
    ...
    public class A
    {
        public  virtual string Hi() //se usa virtual sobre el metodo que van a sobreescribir
        {
            return "Hola soy A";
        }
    }
    ...
    public class B : A 
    {
        public override string Hi()  //se usa override en el metodo que sobreescribe
        {
            return base.Hi() + "Hola soy b"; //base, se usa para ejecutar lo del metodo padre invocado
        }
    }
}
